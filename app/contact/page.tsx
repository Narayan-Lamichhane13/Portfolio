...
/** ======= CLUELY-STYLE ON-TEXT SCRUBBER NAME ======= */
function ScrubGradientName({ name }: { name: string }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* vertical line */}
        <div className="h-full w-px bg-white/70 shadow-[0_0_0_1px_rgba(0,0,0,0.05)] mix-blend-overlay" />
        {/* knob */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="text-center">
            ...
            >
              ...
              <a href="#" className="p-3 bg-white/80 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110">
